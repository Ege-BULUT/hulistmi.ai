...
>;
// Huawei slugs use "_" as well as "-", even as the first character
// (bpta-image_get_and_save, js-apis-net-http_1, _ark_ui_compile).
const DOCUMENT_SLUG_PATTERN = /^[a-z0-9_][a-z0-9_-]*$/;
